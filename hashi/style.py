...
_ICONS: dict[str, list[tuple]] = {
    ...
    # 2 ペイン(ローカル⇔リモート、#82)のトグル用。左右に並んだ 2 枚の面。
    "dualpane": [("rect", 1.5, 3, 5.5, 10), ("rect", 9, 3, 5.5, 10)],
    # 同期ブラウズ(#82 第 2 段)。左右が連動することを表す両向き矢印。
    # forward(片道の矢印 2 本 = ポート転送)とは別物なので混ぜないこと。
    "sync": [("line", 2.5, 8, 13.5, 8), ("line", 5, 5.5, 2.5, 8),
             ("line", 5, 10.5, 2.5, 8), ("line", 11, 5.5, 13.5, 8),
             ("line", 11, 10.5, 13.5, 8)],
